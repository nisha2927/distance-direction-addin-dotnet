        ...
        if (results.geometry.type === 'polyline') {
          if (this.lengthInput.get('value') !== undefined || this.angleInput.get('value') !== undefined) {
            ...
            this.currentLine.graphic = new EsriGraphic(
              geom,
              this._lineSym, {
                'GeoLength': this.lengthInput.get('value').toString() + " " +
                  this.lengthUnitDD.get('value').charAt(0).toUpperCase() + this.lengthUnitDD.get('value').slice(1),
                'LineAngle': this.angleInput.get('value').toString() + " " +
                  this.angleUnitDD.get('value').charAt(0).toUpperCase() + this.angleUnitDD.get('value').slice(1)
              }
            );
