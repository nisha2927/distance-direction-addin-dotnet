    ...
    */
    ...
    _onClickHandler: function (evt) {
      ...
      if (this._points.length === 1 && this._geometryType === 'polyline') {
        ...
        if (tooltip) {
          tooltip.innerHTML = jimuUtils.sanitizeHTML(this.nls.clickToFinishLineMessage);
        }
      }
    },
    ...
    _onMouseMoveHandler: function (evt) {
      ...
      **/
      ...
      var unitlength = this.coordTool.convertMetersToUnits(majorAxisLength, this.lengthUnit);
